 ...
 */
public class FieldDef2JavaGen {
    private static String CODE_TEMPLATE;
    private static final String TEMPLATE_TOKEN_CLASS_DEFAULT = "KnownFieldId";
    ...
    private Iterable<FieldDefinition> fields;

    public FieldDef2JavaGen(@NonNull Iterable<FieldDefinition> fields) {
        this.fields  = fields;
    }
    ...
    public String generateCode(boolean bSaveToFile) throws IOException {
        ...
        //Step 2 of 3
        String code = JavaGenCommon.fieldDefsToCode(fields);
