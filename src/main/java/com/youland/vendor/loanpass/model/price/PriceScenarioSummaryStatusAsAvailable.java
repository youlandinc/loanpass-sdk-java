...
@Data
public class PriceScenarioSummaryStatusAsAvailable extends AnyOfPriceScenarioSummaryStatus {
    public static final String FIELD_NAME_REQUIREDFIELDIDS = "requiredFieldIds";

    private List<String> requiredFieldIds;

    public PriceScenarioSummaryStatusAsAvailable() { super(PriceScenarioSummaryStatusOpt.AVAILABLE); }

    public PriceScenarioSummaryStatusAsAvailable fromJson(@NonNull JsonNode node)  {
