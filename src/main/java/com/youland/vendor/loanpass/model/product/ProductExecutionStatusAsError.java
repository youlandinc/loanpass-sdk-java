...
@Data
public class ProductExecutionStatusAsError extends AnyOfProductExecutionStatus {
    public static final String FIELD_NAME_ERRORS = "errors";

    private List<ExecutionError> errors;

    public ProductExecutionStatusAsError() { super(ProductExecutionStatusOpt.ERROR); }

    public ProductExecutionStatusAsError fromJson(@NonNull JsonNode node)  {
