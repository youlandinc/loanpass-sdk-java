...
@Data
public class FieldValueTypeAsEnum extends AnyOfFieldValueType {
    public static final String FIELD_NAME_ENUMTYPEID = "enumTypeId";

    private String enumTypeId;

    public FieldValueTypeAsEnum() { super(FieldValueTypeOpt.ENUM); }

    public FieldValueTypeAsEnum fromJson(@NonNull JsonNode node)  {
