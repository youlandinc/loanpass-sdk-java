...
public enum ProductSummaryStatusOpt implements ValueObservable<String> {
    AVAILABLE ("available"),
    APPROVED ("approved"),
    REJECTED ("rejected"),
    ERROR ("error"),
    ...
    public static final Map<String, ProductSummaryStatusOpt> VALUE2ENUM
            = ValueObservable.createMapValue2Obj(ProductSummaryStatusOpt.values());

    private final String value;

    ProductSummaryStatusOpt(String value) {
        this.value = value;
    }
}
