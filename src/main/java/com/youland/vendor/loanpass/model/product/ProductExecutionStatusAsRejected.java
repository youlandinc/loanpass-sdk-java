...
@Data
public class ProductExecutionStatusAsRejected extends AnyOfProductExecutionStatus {
    public static final String FIELD_NAME_ERRORS = "errors";

    private List<ExecutionError> errors;

    public ProductExecutionStatusAsRejected() { super(ProductExecutionStatusOpt.REJECTED); }

    public ProductExecutionStatusAsRejected fromJson(@NonNull JsonNode node)  {
