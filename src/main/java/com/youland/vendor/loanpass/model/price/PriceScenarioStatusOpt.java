...
public enum PriceScenarioStatusOpt implements ValueObservable<String> {
    ERROR ("error"),
    REJECTED ("rejected"),
    APPROVED ("approved"),
    MISSING_CONFIGURATION  ("missing-configuration");

    public static final Map<String, PriceScenarioStatusOpt> VALUE2ENUM
            = ValueObservable.createMapValue2Obj(PriceScenarioStatusOpt.values());

    private final String value;

    PriceScenarioStatusOpt(String value) {
        this.value = value;
    }
}