...
public class ExecProductRequestTest {
    private static final String FOLDER_TEST ="./src/test/testdata/execproduct/";
    private static final Object[] _testData = {
            FOLDER_TEST + "request2response_error.json"
    };

    public static ExecProductRequest createRequestOk() throws IOException {
        ExecProductRequest obj
                = JsonUtil.file2Obj(FOLDER_TEST + "request2response_ok.json", ExecProductRequest.class);
        return obj;
    }
    ...
    void test_deserialize(String filename) throws IOException {
        ...
        //Action
        ExecProductRequest obj
                = JsonUtil.file2Obj(filename, ExecProductRequest.class);
