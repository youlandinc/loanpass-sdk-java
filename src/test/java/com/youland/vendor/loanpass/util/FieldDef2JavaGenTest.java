...
class FieldDef2JavaGenTest {
    ...
    /**
     * Generate Java code containing Field IDs from "./src/test/testdata/config/response_sample.json" *
     * If you don't see the Field IDs of interest, you need to update response_sample.json first using
     * Postman
     * @throws IOException
     */
    @Test
    void test_generateCode() throws IOException {
        ...
        FieldDef2JavaGen codegen = new FieldDef2JavaGen(response.getCreditApplicationFields());
